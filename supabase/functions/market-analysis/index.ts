...
5. 경제·금융·거시경제·기업실적·수출입·통화정책과 직접 관련된 뉴스만 분석하세요. 지역행사·복지·사회면 뉴스는 완전히 무시하세요.
6. 문자열 내 큰따옴표 절대 사용금지 (작은따옴표 사용).
7. confidence가 50 미만인 요인은 factors 배열에서 완전히 생략하세요.
8. 반드시 순수 JSON만 출력하세요. 마크다운 코드 블록(\`\`\`) 금지.`
